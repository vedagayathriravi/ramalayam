...
(function () {
    ...
    const translations = {
        te: {
            ...
            'sevas.lede': 'ప్రస్తుతం బుక్ చేసుకునే స్పాన్సర్‌డ్ సేవలు లేవు. భక్తిశ్రద్ధలతో నిర్వహించే ఈ వారపు కార్యక్రమాలు అందరి భక్తులకు అందుబాటులో — కుటుంబ సమేతంగా విచ్చేసి పాల్గొనండి.',
            ...
            'sevas.note': 'అందరు భక్తులకు స్వాగతం — ఈ వారపు కార్యక్రమాలకు బుకింగ్ అవసరం లేదు.',
