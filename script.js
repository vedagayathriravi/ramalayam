...
(function () {
    ...
    const translations = {
        te: {
            ...
            'darshan.lede': 'దక్షిణ భారత ఆలయ సంప్రదాయం ప్రకారం, రోజు సుప్రభాతం, అభిషేకం, నైవేద్యం, హారతితో ముందుకు సాగుతుంది. ఈ పవిత్ర ఆంధ్ర కర్మల సమయంలో దర్శనం చేసుకోండి.',
    ...
    /* =========================================================
       ...
       ========================================================= */
    const sections = ['home','about','darshan','sevas','festivals','gallery','videos','stotras','donate','contact']
