...
(function () {
    ...
    const translations = {
        te: {
            ...
            'sevas.eventsNote': '<strong>అన్నదానం &amp; చిన్న కార్యక్రమాలు:</strong> అన్నదానం చేయాలనుకుంటే లేదా ఆలయంలో చిన్న కార్యక్రమం (భజన, birthday, memorial, సమావేశం) — కమిటీని సంప్రదించండి. ఏర్పాటు చేయడంలో సంతోషంగా సహకరిస్తాము.',
            'sevas.archanaNote': '<strong>నెలవారీ &amp; వార్షిక అర్చన:</strong> శ్రీ రామ, శ్రీ సీత, శ్రీ హనుమాన్ వారికి నెలవారీ లేదా వార్షిక అర్చన చేయాలనుకుంటే — ఫోన్ లేదా ఇమెయిల్ ద్వారా కమిటీని సంప్రదించండి.',
            ...
            'donate.lede': 'మీ సహకారం దైనందిన పూజ, అన్నదానం, పండుగలు, ఆలయ నిర్వహణకు తోడ్పడుతుంది. అన్నదానం, నెలవారీ/వార్షిక అర్చన, చిన్న కార్యక్రమాలు, విరాళాల కోసం కమిటీని సంప్రదించండి — బ్యాంక్ ఖాతా తెరవబడిన తర్వాత ఆన్‌లైన్ వివరాలు ఇక్కడ జోడించబడతాయి.',
            'donate.p1.title': 'అన్నదానం',
            'donate.p1.body': 'భక్తులకు అన్నదానం — తేదీ ఎంచుకుని ఆలయంలో ఏర్పాటు చేయడానికి కమిటీని సంప్రదించండి.',
            'donate.p2.title': 'నెలవారీ &amp; వార్షిక అర్చన',
            'donate.p2.body': 'మీ పేరు లేదా కుటుంబ పేరున నెలవారీ లేదా వార్షిక అర్చన — ఏర్పాటు కోసం కమిటీని సంప్రదించండి.',
            'donate.p3.title': 'చిన్న ఆలయ కార్యక్రమాలు',
            'donate.p3.body': 'భజన, birthday, memorial, లేదా ఇతర చిన్న సమావేశాలు — ఏర్పాటు చేయడానికి కమిటీని సంప్రదించండి.',
            'donate.p4.title': 'పునరుద్ధరణ నిధి',
            'donate.p4.body': 'ఆలయ నిర్వహణ మరియు విస్తరణకు సహకారం.',
            ...
            'donate.ifsc': 'IFSC',
            'donate.upi': 'UPI',
            'donate.bankNote': 'అన్నదానం, నెలవారీ/వార్షిక అర్చన, చిన్న కార్యక్రమం, లేదా విరాళం — కమిటీని సంప్రదించండి. ప్రతి సహాయం భక్తితో స్వాగతం.',

            'contact.eyebrow': 'మమ్మల్ని సందర్శించండి',
            'contact.title': 'ఆలయానికి <span>చేరుకోండి</span>',
            'contact.lede': 'ప్రశాంత రామనగర్‌లో మా ఆలయ ద్వారాలు అందరు భక్తులకు తెరిచి ఉంటాయి. పూజ, నెలవారీ/వార్షిక అర్చన, అన్నదానం, చిన్న కార్యక్రమాలు, విరాళాలు — పూజారి లేదా కమిటీని ఫోన్ లేదా ఇమెయిల్ ద్వారా సంప్రదించండి.',
            ...
            'contact.emailSub': 'పూజారి &amp; కమిటీ · పూజ, అర్చన, అన్నదానం &amp; కార్యక్రమాలు',
