...
- **Welcome intro screen** with a photo of Sri Rama, Sita, and Lakshmana (`intro-altar.jpg`), Telugu chant *"శ్రీ రామ జయ రామ జయ జయ రామ"*, and an "Enter the Temple" button.
...
├── intro-altar.jpg # Sri Rama, Sita & Lakshmana (intro + link preview)
└── README.md       # This file
```
